...
"""autogenerated by genpy from project7/Navigate2DActionResult.msg. Do not edit."""
import sys
...
class Navigate2DActionResult(genpy.Message):
  ...
  _type = "project7/Navigate2DActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','project7/Navigate2DResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = project7.msg.Navigate2DResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = project7.msg.Navigate2DResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_f().pack(self.result.elapsed_time))
